...
> **개발 기간은 11~15주차 약 5주다.** 1~9주차는 비대면 이론 강의를 각자 수강하고 10주차에
> 필기 중간고사(30%)를 본다. 11주차 계획서 발표, 12~14주차 주간 점검, 15주차 최종 발표·시연과
> 최종보고서로 끝난다. 자세한 것은 [docs/course.md](docs/course.md).
...
**초기 단계 — 기술 스택·기반 논문·백본 모두 미정.**

11주차 계획서 발표 때 범위와 역할이 확정돼 있어야 하고, 그 뒤로는 매주 점검이 있다.
**10주차 이전까지 준비**할 것:

- [x] 저장소 생성, 교과목·환경·협업 문서 골격
- [ ] 팀 구성과 경로 오너십 확정 → [docs/architecture.md](docs/architecture.md)
- [ ] 관련 연구 조사, 접근 방식·기반 논문 선정
- [ ] 실행 환경 구성 → `docker/`
- [ ] MORAI 연결 확인 (시뮬 실습 주차에 병행)

**11주차 계획서 발표 이후:**

- [ ] 모듈 경계 확정 → `src/` 구조 생성
- [ ] 12·13·14주차 점검에서 보여줄 주 단위 목표 설정
- [ ] 15주차 최종 발표·시연, 최종보고서
