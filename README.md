...
> 시험 기간을 빼면 쓸 수 있는 주는 **3·4·5 / 9 / 11·12·13 — 흩어진 7주**다.
> 10주차에 필기 중간고사(30%), 11주차 계획서 발표, 12~14주차 점검, 15주차 최종 발표·시연과
> 최종보고서. 자세한 것은 [docs/course.md](docs/course.md) §3.
...
> **6~8주차는 시험 기간으로 중단된다.** 5주차 말에는 반드시 **돌아가는 상태로 커밋**하고
> [작업 기록](docs/notes/)을 남긴다. 반쯤 고친 채로 두면 복귀에만 한 주가 든다.

**2블록 (9주차) — 1주뿐**

- [ ] 공백 복귀, 환경·빌드 재확인
- [ ] 11주차 계획서에 쓸 진행 내용 정리

**3블록 (11·12·13주차)**

- [ ] 11주차 설계 프로젝트 계획서 발표 (지금까지 만든 것 + 남은 3주 계획)
- [ ] 12·13주차 점검에서 보여줄 주 단위 목표
- [ ] **13주차 말 기능 동결** — 이후는 안정화만
