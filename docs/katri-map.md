...
**535(주차금지)는 주차칸이 아니다.** "여기 세우지 마라" 선이고, 27개가 K-City 구간
`x 50~107, y 1150~1236` 한 곳에 몰려 있다. 5 m 짜리 짧은 선이 2.5 m 간격으로 반복되는
주차장 패턴은 맵 어디에도 없다 (짧은 선 412개 전수 조사, 20 m 격자 밀집도 상위 12곳 확인).

> 515 / 531 의 NGII 정식 명칭은 확정하지 못했다. 주차 기능에 영향이 없어 그대로 둔다.
